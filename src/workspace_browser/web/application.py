...
let playbackTimer=null,playbackPosition=0,playbackPaused=false,playbackFollowLive=false,plotResizeObserver=null,dataStageResizeFrame=null,progressLogs=[],activePlaybackSeek=null;
...
function stopPlayback(){clearInterval(playbackTimer);playbackTimer=null;activePlaybackSeek=null;plotResizeObserver?.disconnect();plotResizeObserver=null;cancelAnimationFrame(dataStageResizeFrame);dataStageResizeFrame=null;window.removeEventListener('resize',sizeDataStage)}
