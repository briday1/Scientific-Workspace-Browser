    ...
    *,
    ...
    return WorkspaceBrowserApp(
        ...
        workspace_modules=(
            ...
            WorkspaceModuleRegistration("workspace_browser.examples.lfm_collection", "create_workspace"),
            WorkspaceModuleRegistration("workspace_browser.examples.lfm_full_recording", "create_workspace"),
